...
import { Phone, Mail, MapPin, YoutubeIcon, InstagramIcon } from 'lucide-react';
...
const Footer: React.FC = () => {
  return (<footer className="bg-[#FDF8F3] dark:bg-[#1f1f1f] transition-all duration-300 ease-in-out pt-6 pb-8">
    <div className="container mx-auto px-6">
      ...
      <p className='text-center dark:text-white text-black mb-2'>Stay Connected with SARA
        {/* Follow SARA on all platforms for the latest updates, content, and behind-the-scenes! */}
        </p>
      <div className='flex justify-center items-center gap-8 mb-4'>
        <a href="https://www.instagram.com/sara.ai_23/" target="_blank" rel="noopener noreferrer" title='Instagram'>
        <InstagramIcon className='h-5 w-5  text-pink-600 hover:text-pink-700 '/></a>
        <a href="https://www.youtube.com/@saraai-i2v" target="_blank" rel="noopener noreferrer" title='Youtube'>
        <YoutubeIcon className='h-7 w-6 text-red-600 hover:text-red-700'/></a>
      </div>
      ...
      <div className="border-t border-gray-800 dark:border-gray-200 pt-8 text-center  dark:bg-[#1f1f1f] transition-colors duration-300">
        <p className="text-black dark:text-white mt-3">© Sara-AI All Right Reserved, 2023-2025</p>
      </div>
    </div>
  </footer>
  );
