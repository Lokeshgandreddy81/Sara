import { Lightbulb, Clock, Heart,  Globe, Pencil, Sparkles,  } from "lucide-react";
...
const Features: React.FC = () => {
    return (
        <>
            <div className="bg-white dark:bg-[#1b2736] duration-300 ease-in-out py-16 md:py-24 relative" id='Features'>

                <div className="absolute left-5 top-10 md:left-10 md:top-20 bg-white dark:bg-[#1b2736] transition-all duration-300 ease-in-out">
                ...
                <div className="absolute right-5 top-20 md:right-10 md:top-40">
                    ...
                    <FloatingIcon className="bottom-1/4 right-1/2 dark:text-[#4c5bd4]  hover:text-transparent dark:hover:text-transparent duration-2 00 ease-in-out"><Sparkles className="w-10 h-10 md:w-12 md:h-12" /></FloatingIcon>

                </div>

                <div className="container mx-auto px-6">
                    <div className="text-center mb-12 md:mb-16">
                        <h2 className="text-3xl md:text-6xl font-bold mb-4 text-black dark:text-orange-500 transition-all duration-300 ease-in-out">Let's
                            <span> Learn</span>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 '>
                        <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform hover:-translate-y-2 transition-all duration-300 ease-in-out bg-white dark:bg-[#253243]  p-4 md:p-6 hover:shadow-xl transition-shadow">
            ...
            <div className="py-16 md:py-24 bg-[#FDF8f6] dark:bg-[#1b2736] transition-all duration-300 ease-in-out" id='Details_Smart_study_Guide'>
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="relative">
                            ...
                            <Clock className="absolute top-4 left-4 text-blue-600 w-8 h-8 animate-float" />
                            <Heart className="absolute top-4 right-4 text-red-600 w-8 h-8 animate-float" />
                            <Globe className="absolute bottom-4 left-4 text-green-600 w-8 h-8 animate-float" />
                            <Pencil className="absolute bottom-4 right-4 text-purple-600 w-8 h-8 animate-float" />
                        </div>
                        <div>
            ...
            <div className="py-16 md:py-24  dark:bg-[#1b2736] transition-all duration-300 ease-in-out" id="Details_Youtube_Video_Tutorials">
                <div className="container mx-auto px-6 ">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            </div><div className="py-16 md:py-24 bg-[#FDF8f6] dark:bg-[#1b2736] transition-all duration-300 ease-in-out" id='Details_Mental_Health_Support'>
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="relative">
                            <img
                                ...
                                alt="Student studying"
                                className="rounded-lg shadow-xl" />
                            <Clock className="absolute top-4 left-4 text-blue-600 w-8 h-8 animate-float hover:color-transparent" />
                            <Heart className="absolute top-4 right-4 text-red-600 w-8 h-8 animate-float hover:color-transparent" />
                            <Globe className="absolute bottom-4 left-4 text-green-600 w-8 h-8 animate-float hover:color-transparent" />
                            <Pencil className="absolute bottom-4 right-4 text-purple-600 w-8 h-8 animate-float hover:color-transparent" />
                        </div>
                        <div>
